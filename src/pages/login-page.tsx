...
const Login = () => {
  ...
  return (
    <div className="login w-1/2 h-[844px] ">
      <div className="left_side bg-rede ">
        ...
        <div className="right_side">
          ...
          <button
            className=" button_signup w-[350px] bg-red-500 rounded-[5px] h-[41px] left-[870px] top-[330px] absolute"
            type="button"
          >
          ...
          <Link to="/signup">
            <div className="text-center h-[19px] pl-1.5 left-[1060px] top-[395px] absolute flex items-center w-[350px] text-red-500 text-base font-bold font-['Raleway']">
              Sign up for free
            </div>
          </Link>
          <div className="or left-[1030px] top-[430px] absolute text-zinc-600 text-[13px] font-bold font-['Raleway']">
            OR
          </div>
