  ...
  return (
    <div className="z-0 max-w-[91%] py-32 mx-auto">
      ...
      <div className="grid grid-cols-3 gap-20 h-80 px-32 py-4 dark:text-white">
        <button
          id="HMB"
          className="col-span-1 bg-white dark:bg-blacke drop-shadow-lg dark:drop-shadow-lgL rounded-lg flex justify-center items-center align-stretch flex-col h-max py-[42px] hover:bg-gray-100 dark:hover:bg-black"
        >
